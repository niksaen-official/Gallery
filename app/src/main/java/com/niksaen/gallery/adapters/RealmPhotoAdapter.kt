...
class RealmPhotoAdapter(private val context: Context?, private val photos:List<RealmPhoto>) : RecyclerView.Adapter<RealmPhotoAdapter.Holder>() {
    ...
    fun getItem(position: Int):RealmPhoto{ return photos[position] }
